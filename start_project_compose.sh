...
# Honey, I Love You But I Can't Watch That - Docker Compose Startup Script
# This script starts the OMDB MCP server using docker-compose and the Streamlit app
...
# Start OMDB MCP Server with docker-compose
print_status "Starting OMDB MCP Server with Docker Compose..."
...
if port_in_use 8081; then
    ...
    print_status "Building and starting MCP server..."
    ...
    if wait_for_service 8081 "OMDB MCP Server"; then
        ...
        print_status "View logs: docker-compose logs -f omdb-mcp-server"
    else
...
while true; do
    ...
    if ! docker-compose ps | grep -q "Up"; then
        print_error "Docker Compose services have stopped unexpectedly"
        break
    fi
